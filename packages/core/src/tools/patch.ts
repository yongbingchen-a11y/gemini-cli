...
> {
  ...
  constructor(private readonly config: Config) {
    super(
      PatchTool.Name,
      'Patch',
      'Applies a multi-file code change using the standard unified diff format. The diff must be complete and well-formed. This tool can create, delete, and modify multiple files in a single operation.',
      Kind.Edit,
      {
        properties: {
          unified_diff: {
